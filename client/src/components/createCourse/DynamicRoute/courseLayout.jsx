    ...
    const GenerateChapterContent = async () => {
        ...
        try {
            for (const [index, chapter] of chapters.entries()) {
                const PROMPT = 'Explain the concept in detail on Topic:'+course.name+', Chapter:'+chapter["Chapter Name"]+', in JSON Format with list of array with field as title, description in detail, Code Example(Code field in <precode> format) if applicable, Real life Analogy';
                ...
                // Fetch video content
                try {
                    const videoResponse = await service.getVideos(`${course.courseOutput["Course Name"]}:${chapter["Chapter Name"]}`);
        ...
        <div className="mt-10 px-7 md:px-20 lg:px-44">
            ...
            {course ? (
                <>
                    ...
                    <Button className="my-10 bg-blue-700 text-white" onClick={GenerateChapterContent}>
